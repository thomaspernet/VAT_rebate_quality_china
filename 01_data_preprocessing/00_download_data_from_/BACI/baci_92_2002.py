...
drive.download_file(
filename = 'baci92_2002.csv',
file_id = '1uM2uiXkDXAMC95WukXGqX_zGDZCczCf0',
...
s3.upload_file(file_to_upload = '../../../00_Data_catalogue/temporary_local_data/baci92_2002.csv',
destination_in_s3 = 'ADDITIONAL_DATA/BACI')
