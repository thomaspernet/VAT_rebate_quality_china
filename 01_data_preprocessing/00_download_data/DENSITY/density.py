...
PATH_S3 = "DATA/ECON/TRADE_DATA/CHINA/DENSITY"  ### Copy destination in S3 without bucket and "/" at the end
### GCP
...
FILENAME_SPREADSHEET = "density"
spreadsheet_id = drive.find_file_id(FILENAME_SPREADSHEET, to_print=False)
sheetName = 'density.csv'
var = (
...
{"Name":"density_china_ville", "Type":"float", "Comment":"Density china city-product"},
{"Name":"geocode4_corr", "Type":"string", "Comment":"Chinese city code"},
]

### ADD DESCRIPTION
description = 'Download city-product Density China'
