...
PATH_S3 = "DATA/ECON/LOOKUP_DATA/CHINA/INDUSTRY_CHARACTERISTICS/SKILLED_ORIENTED"  ### Copy destination in S3 without bucket and "/" at the end
### GCP
...
.loc[lambda x: x['skilled'].isin(['SKILLED_ORIENTED'])]
.assign(
...
{"Name":"skilled", "Type":"string", "Comment":"Industry skilled oriented"}
]

### ADD DESCRIPTION
description = 'List industry HS4 skilled oriented'
