...
PATH_S3 = "DATA/ECON/LOOKUP_DATA/CHINA/INDUSTRY_CHARACTERISTICS/ENERGY"  ### Copy destination in S3 without bucket and "/" at the end
### GCP
...
{"Name":"energy", "Type":"string", "Comment":"products that consume a large amount of energy,"}
]

### ADD DESCRIPTION
description = 'List HS6 with large energy intensity'
