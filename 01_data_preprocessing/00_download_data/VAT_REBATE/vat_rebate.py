...
PATH_S3 = "DATA/ECON/TAX_DATA/CHINA_VAT_REBATE"  ### Copy destination in S3 without bucket and "/" at the end
### GCP
...
FILENAME_SPREADSHEET = "base_hs6_VAT_2002_2012"
...
var = var.assign(
vat_m = lambda x: x['vat_m'].apply(pd.to_numeric, errors='coerce'),
vat_reb_m = lambda x: x['vat_reb_m'].apply(pd.to_numeric, errors='coerce'),
tax_rebate = lambda x: x['tax_rebate'].apply(pd.to_numeric, errors='coerce'),
)
...
### ADD DESCRIPTION
description = 'Download vat rebate'
...
TablePrefix = 'hs6_' ## add "_" after prefix, ex: hello_
