...
PATH_S3 = "DATA/ECON/TRADE_DATA/BACI/EXPORT"  ### Copy destination in S3 without bucket and "/" at the end
### GCP
...
FILENAME_DRIVE = 'baci92_2002.csv.zip'
...
zip.extractall(path=tempfile.gettempdir())
pd.read_csv(
os.path.join(
tempfile.gettempdir(),
'baci92_2002.csv'
...
{"Name":"i", "Type":"string", "Comment":"origin country ID"},
{"Name":"j", "Type":"string", "Comment":"Destination country ID"},
{"Name":"v", "Type":"float", "Comment":"Export value"},
{"Name":"q", "Type":"float", "Comment":"Export quantity"},
]

### ADD DESCRIPTION
description = 'Download Baci export values HS6 country source destination'
