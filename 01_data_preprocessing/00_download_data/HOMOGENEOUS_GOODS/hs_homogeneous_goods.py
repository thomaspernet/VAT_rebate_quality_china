...
PATH_S3 = "TRADE_DATA/RAW/GOODS_CLASSIFICATION/HOMOGENEOUS"  ### Copy destination in S3 without bucket and "/" at the end
### GCP
...
FILENAME_SPREADSHEET = "homogeneous"
...
{"Name":"goods", "Type":"string", "Comment":"0 is homoegeous and 1 is heterogeneous"},
{"Name":"homogeneous", "Type":"string", "Comment":"Goods label"}
]

### ADD DESCRIPTION
description = 'Download homogeneous goods from R library concordance'
...
filename = 'hs_homogeneous_goods.py'
