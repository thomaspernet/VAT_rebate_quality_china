...
PATH_S3 = "DATA/ECON/LOOKUP_DATA/COUNTRY_NAME"  ### Copy destination in S3 without bucket and "/" at the end
### GCP
...
FILENAME_SPREADSHEET = "country_cn_en - bigquery"
spreadsheet_id = drive.find_file_id(FILENAME_SPREADSHEET, to_print=False)
sheetName = 'country_cn_en - bigquery.csv'
var = (
...
### ADD SHCEMA
schema = [
{"Name":"country_cn", "Type":"string", "Comment":"Chinese country name"},
{"Name":"country_en", "Type":"string", "Comment":"English country name"},
{"Name":"iso_alpha", "Type":"string", "Comment":"country ID 1"},
{"Name":"code", "Type":"string", "Comment":"country ID 2"},
{"Name":"index", "Type":"int", "Comment":"index"},
]

### ADD DESCRIPTION
description = 'Download chinese country name (initialy in big query)'
...
filename = 'chinese_country_name.py'
