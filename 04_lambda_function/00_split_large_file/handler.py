...
def load_n_split(event, context):
    ...
    for record in event['Records']:
        ...
        key_output = record['s3']['output']['key']
        file_row_limit = record['s3']['row_limit']['limit']
        ...
        output_path = os.path.join(bucket,key_output)
